...
cmake -G %ProjectGenerator32Bit% ../.. -DCMAKE_INSTALL_PREFIX:PATH="../%ProjectName%_%ProjectVersion%_static_x86_%ProjectLibSufix%" ^
        -DUTILITY_SUPPORT_QT=OFF  -DUTILITY_BUILD_STATIC_RUNTIME=ON -DUTILITY_SUPPORT_WINXP=OFF -DUTILITY_BUILD_TEST=OFF -DCMAKE_PREFIX_PATH:STRING="%ProjectDependPath%"
...
cmake -G %ProjectGenerator32Bit% ../.. -DCMAKE_INSTALL_PREFIX:PATH="../%ProjectName%_%ProjectVersion%_dynamic_x86_%ProjectLibSufix%" ^
        -DUTILITY_SUPPORT_QT=OFF  -DUTILITY_BUILD_STATIC_RUNTIME=OFF -DUTILITY_SUPPORT_WINXP=OFF -DUTILITY_BUILD_TEST=OFF -DCMAKE_PREFIX_PATH:STRING="%ProjectDependPath%"
cmake --build   . --config Debug
cmake --build   . --config RelWithDebInfo
cmake --install . --config Debug
cmake --install . --config RelWithDebInfo
